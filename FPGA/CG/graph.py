...
ax1.plot(size[:3],GPU_wo_Mem[:3],'b',marker='*', label='FPGA total')
ax1.plot(size[2:],CPU[2:],'k',marker='d', label='CPU, Linear Operator')
ax1.plot(size[2:],GPU_Mem[2:],'r',marker='d', label='FGPA exec, Linear Operator')
ax1.plot(size[2:],GPU_wo_Mem[2:],'b',marker='d', label='FPGA total, Linear Operator')
ax1.set_xscale("log")
ax1.grid()
ax1.legend()
