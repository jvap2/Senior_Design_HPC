...
ax1.plot(size[:3],GPU_Mem[:3],'r',marker='*', label='FPGA total')
ax1.plot(size[:3],GPU_wo_Mem[:3],'b',marker='*', label='FPGA exec')
ax1.plot(size[2:],CPU[2:],'k',marker='d', label='CPU, Linear Operator')
ax1.plot(size[2:],GPU_Mem[2:],'r',marker='d', label='FGPA total, Linear Operator')
ax1.plot(size[2:],GPU_wo_Mem[2:],'b',marker='d', label='FPGA exec, Linear Operator')
ax1.set_xscale("log")
ax1.grid()
ax1.legend()
...
ax3.plot(size[2:],SU_Mem[2:],'k', marker='d',label='FPGA total, Linear Operator')
ax3.plot(size[2:],SU_wo_Mem[2:],'r',marker='d', label='FPGA exec, Linear Operator')
ax3.set_xscale("log")
ax3.grid()
ax3.legend()
