#include <algorithm>
#include <cstdlib>
#include "/home/sureshm/EE_4830_GPU/Senior_Design_HPC/FPGA/L_2/L_2/src/xcl2.hpp"
...
int main(int argc, char **argv)
{
    ...
    int indexes = (int)size / 4;
//    if ((int)size % (VEC * LATENCY) != 0)
//    {
//        std::cout << "Number of input indexes must be a multiple of V size * FADD latency (" << VEC << " * " << LATENCY << ")" << std::endl;
//        return EXIT_FAILURE;
//    }
    ...
    V* host_array = (V *) queue.enqueueMapBuffer(device_array, CL_TRUE, CL_MAP_WRITE, 0, size_bytes, NULL, NULL, &err);
    if (err != CL_SUCCESS)
    {
